...
\foreach \i in {0,1,1,0,0,0,1,0,0,
    ...
    \node[X] {\i};
\draw[B] ( A-2.south west) -- node[below=2mm] {F} ( A-4.south east);
\draw[B=] ( A-5.north west) -- node[above=2mm] {F in 1} ( A-6.north east);
\draw[B] ( A-7.south west) -- node[below=2mm] {F in 2} ( A-8.south east);
\draw[B=] ( A-9.north west) -- node[above=2mm] {W out} ( A-10.north east);
\draw[B] ( A-11.south west) -- node[below=2mm] {S out} ( A-12.south east);
\draw[B=] ( A-13.north west) -- node[above=2mm] {E out} ( A-14.north east);
\draw[B] ( A-15.south west) -- node[below=2mm] {N out} ( A-16.south east);
    \end{tikzpicture}
	\end{subfigure}
	~
...
\begin{figure}
\centering
\includegraphics[width=.7\textwidth]{landscape.png}
